...
Quando você começa a construção de uma comunidade, seu programa não precisa funcionar
...
Inicialmente, o propósito do Portal era apenas compartilhar os softwares desenvolvidos
...
a atribuição de bem público ao software e a obrigatoriedade do software estar no Portal do
Software Público. Embora haja algumas diferenças entre o que é um software
