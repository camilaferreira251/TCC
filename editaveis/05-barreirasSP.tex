...
Enviamos também o questionário do Anexo~\ref{anexo e} para um gestor de cada 
...
Para 18 das 19 respostas ao questionário, os desenvolvedores
...
não só técnico mas do software também, a comunidade muitas vezes ficam frustradas 
...
descritas a seguir nas quais as assinaladas com ``*'' são barreiras encontradas
apenas para projetos de software público.
...
A primeira categoria relatada na pesquisa de \citeonline{steinmancher2015} é chamada \textbf{Problemas
...
A \textbf{Hierarquia} é uma categoria relatada apenas para projetos de
...
de software livre foram encontradas para software público.
